...
import { Heading, Image, IconButton, Text, Flex, useModal, CogIcon, SyncAltIcon } from '@pancakeswap-libs/uikit'
  ...
  return (
    <StyledPageHeader>
      <Flex alignItems="center">
        <Details>
          <StyledHeading mb="8px"><StyledImage src="/images/chewy/logo.png" width={50} height={50} /> {title}</StyledHeading>
          {description && (
