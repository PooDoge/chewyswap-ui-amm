...
import { ChainId, Currency, currencyEquals, ETHER, Percent, WETH } from '@pancakeswap-libs/sdk'
...
export default function RemoveLiquidity({
  ...
  const [approval, approveCallback] = useApproveCallback(parsedAmounts[Field.LIQUIDITY], chainId ? ROUTER_ADDRESS[chainId] : ROUTER_ADDRESS[ChainId.MAINNET])
