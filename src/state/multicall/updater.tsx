...
export function outdatedListeningKeys(
  ...
  return Object.keys(listeningKeys).filter((callKey) => {
    ...
    // TEST: DC + Shibarium have shorter block time than BSC, give some wiggle room (Orig - 1)
    const minDataBlockNumber = latestBlockNumber - (blocksPerFetch - 2)
...
export default function Updater(): null {
  ...
  useEffect(() => {
    ...
    const calls = outdatedCallKeys.map((key) => parseCallKey(key))
     .filter(item => item.address.toLowerCase() !== '0xEDedDbde5ffA62545eDF97054edC11013ED72125'.toLowerCase())
